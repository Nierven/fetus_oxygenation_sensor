...
namespace Supervision
{
    ...
    public static class Filtrage
    {
        ...
        *
        ******************************************************************************/
        public static double FiltreOrdre1TpsReel(FiltreOrdre1 filtre, double e_0)
        {
        ...
        public static double FiltreOrdre1TpsReelScaled(FiltreOrdre1 filtre, double e_0, double scale)
        {
         ...
         *
         ******************************************************************************/
        public static double FiltreOrdre2TpsReel(FiltreOrdre2 filtre, double e_0)
        {
         ...
         *
         ******************************************************************************/
        public static double Filtre_Specific_HP4_Butterworth_8Hz_Ech125Hz_TpsReel(FiltreOrdre4 filtre, double e_0)
        {
        ...
        public static double Filtre_Specific_LP4_Butterworth_20Hz_Ech125Hz_TpsReel(FiltreOrdre4 filtre, double e_0)
        {
        ...
        public static double Filtre_Specific_BP4_Tchebytchev_8Hz_20Hz_Ech125Hz_TpsReel(FiltreOrdre4 filtre, double e_0)
        {
            //On calcule la sortie du filtre
            e_0 /= 8.518480096e+00;
        ...
        public static double Filtre_Specific_BP4_Tchebytchev_8Hz_20Hz_Ech250Hz_TpsReel(FiltreOrdre4 filtre, double e_0)
        {
            //On calcule la sortie du filtre
            e_0 /= 3.607295967e+01;
            filtre.s_0 = (filtre.e_4 + e_0) + - 2 * filtre.e_2
        ...
        public static double Filtre_Specific_BP8_Tchebytchev_8Hz_20Hz_Ech125Hz_TpsReel(FiltreOrdre8 filtre, double e_0)
        {
        ...
        public static double Filtre_Specific_BP8_Tchebytchev_8Hz_20Hz_Ech250Hz_TpsReel(FiltreOrdre8 filtre, double e_0)
        {
            //On calcule la sortie du filtre
            e_0 /= 6.251751635e+03;
            filtre.s_0 = (filtre.e_8 + e_0) - 4 * (filtre.e_6 + filtre.e_2) + 6 * filtre.e_4
        ...
        public static double Filtre_Specific_BP8_Tchebytchev_13Hz_20Hz_Ech125Hz_TpsReel(FiltreOrdre8 filtre, double e_0)
        {
         ...
         *
         ******************************************************************************/
        public static void FiltreOrdre1SetOutput(FiltreOrdre1 filtre, double value)
        {
            //Init des sorties
            filtre.s_0 = value;
            filtre.s_1 = value;
        ...
        public static void FiltreOrdre2SetOutput(FiltreOrdre2 filtre, double value)
        {
            //Init des sorties
            filtre.s_0 = value;
            filtre.s_1 = value;
        ...
        public static void FiltrePasseHautButterworthOrdre1SetFrequence(FiltreOrdre1 filtre, double freqEch, double freqCoupure)
        {
        ...
        public static void FiltrePasseBasButterworthOrdre1SetFrequence(FiltreOrdre1 filtre, double freqEch, double freqCoupure)
        {
            filtre.w0 = freqCoupure * 2 * Math.PI;
            filtre.ts = 1 / freqEch;
            filtre.c = 1 / Math.Tan(filtre.w0 * filtre.ts / 2);
        ...
        public static void FiltrePasseHautButterworthOrdre2SetFrequence(FiltreOrdre2 filtre, double freqEch, double freqCoupure)
        {
            filtre.w0 = freqCoupure * 2 * Math.PI;
        ...
        public static void FiltrePasseBasButterworthOrdre2SetFrequence(FiltreOrdre2 filtre, double freqEch, double freqCoupure)
        {
            filtre.w0 = freqCoupure * 2 * Math.PI;
            filtre.ts = 1 / freqEch;                           //Sample time
            filtre.c = 1 / Math.Tan(filtre.w0 * filtre.ts / 2.0);     //Warping equation
        ...
        public static void FiltreNotchOrdre2SetFrequence(FiltreOrdre2 filtre, double freqEch, double freqNotch)
        {
        ...
        public static void FiltrePasseHautButterworthOrdre1Init(FiltreOrdre1 filtre, double freqEch, double freqCoupure)
        {
            FiltrePasseHautButterworthOrdre1SetFrequence(filtre, freqEch, freqCoupure);
            FiltrePasseHautButterworthOrdre1OutputInit(filtre);
        }

        public static void FiltrePasseHautButterworthOrdre1OutputInit(FiltreOrdre1 filtre)
        {
            filtre.initOutputMode = 2; //passe-haut
        }

        public static void FiltrePasseHautButterworthOrdre2Init(FiltreOrdre2 filtre, double freqEch, double freqCoupure)
        {
            FiltrePasseHautButterworthOrdre2SetFrequence(filtre, freqEch, freqCoupure);
            FiltreOrdre2SetOutput(filtre, 0);
        }

        public static void FiltrePasseBasButterworthOrdre1Init(FiltreOrdre1 filtre, double freqEch, double freqCoupure)
        {
            FiltrePasseBasButterworthOrdre1SetFrequence(filtre, freqEch, freqCoupure);
            FiltrePasseBasButterworthOrdre1OutputInit(filtre);
        }

        public static void FiltrePasseBasButterworthOrdre1OutputInit(FiltreOrdre1 filtre)
        {
            filtre.initOutputMode = 1; //passe-bas
        }

        public static void FiltrePasseBasButterworthOrdre2Init(FiltreOrdre2 filtre, double freqEch, double freqCoupure)
        {
            FiltrePasseBasButterworthOrdre2SetFrequence(filtre, freqEch, freqCoupure);
            FiltreOrdre2SetOutput(filtre, 0);
        }

        public static void FiltreNotchOrdre2Init(FiltreOrdre2 filtre, double freqEch, double freqNotch)
        {
            FiltreNotchOrdre2SetFrequence(filtre, freqEch, freqNotch);
            FiltreOrdre2SetOutput(filtre, 0);
        }

        public static void IntegrateurInit(Integrateur filtre, double freqEch)
        {
        ...
        public static double Integrate(Integrateur filtre, double e_0)
        {
            //On calcule la sortie du filtre
        ...
        public static void IntegrateurReset(Integrateur filtre)
        {
            //Init des sorties
            filtre.s_0 = 0;
            //Init des entrees
        ...
        public static void DerivateurInit(Derivateur filtre, double freqech)
        {
            filtre.fech = freqech;
            //init des entrees
            filtre.e_1 = 0;
        ...
        public static double Derivate(Derivateur filtre, double e_0)
        {
        ...
        public static void FiltreMinMaxOrdre1Init(FiltreMinMaxOrdre1 filtre, long deadZoneDelay, double minTriggerValue)
        {
        ...
        public static bool FiltreMinMaxOrdre1CalculCroissant(FiltreMinMaxOrdre1 filtre, double input, long longTimeStamp)
        {
            bool updateOutput = longTimeStamp - filtre.timeStampLastTriggerUp > filtre.deadZoneDelay;
        ...
        public static bool FiltreMinMaxOrdre1CalculDecroissant(FiltreMinMaxOrdre1 filtre, double input, long longTimeStamp)
        {

            bool updateOutput = longTimeStamp - filtre.timeStampLastTriggerDown > filtre.deadZoneDelay;
        ...
        public static void FiltreMinMaxOrdre1ResetTrig(FiltreMinMaxOrdre1 filtre)
        {
            filtre.trigState = TrigState.Waiting;
            filtre.trigStateStart = TrigState.Waiting;
        }

        public static void FiltreMinMaxOrdre1Reset(FiltreMinMaxOrdre1 filtre)
        {
            filtre.trigState = TrigState.Waiting;
            filtre.trigStateStart = TrigState.Waiting;
            filtre.aMax = 0;
        ...
        public static void FiltreNbRepInit(FiltreNbRep filtre, FiltreMinMaxOrdre1 filtreMinMax, FiltreOrdre1 filtreLP1Min, FiltreOrdre1 filtreLP1Max, double freqCoupure, double freqEch, long deadZoneDelay, double minTriggerValue)
        {
            //Filtre 1
            ...
            FiltreMinMaxOrdre1Init(filtreMinMax, deadZoneDelay, minTriggerValue);
        ...
        public static void FiltreNbRepReset(FiltreNbRep filtre)
        {
            filtre.flag_axe = 'N';
            filtre.periodeRep = 0;
            filtre.timeStampMinMax = 0;
        ...
        public static bool FiltreNbRepProcess(FiltreNbRep filtre, double value, double valueTopMeasure, long timeStamp)
        {
        ...
        public static void IdleDetectorProcess(IdleDetector idleDetector, double accel, long instant)
        {
            ...
            if (accel > (idleDetector.idleAccelRefValue + idleDetector.accelIdleSensitivity) || accel < (idleDetector.idleAccelRefValue - idleDetector.accelIdleSensitivity))
            {
                ...
                idleDetector.flagAccelIdleChanged = idleDetector.flagAccelIdle;
        ...
        public static bool IdleDetectorIsIdle(IdleDetector idleDetector)
        {
            return idleDetector.flagAccelIdle;
        }

        public static bool IdleDetectorStateHasChanged(IdleDetector idleDetector)
        {
            return idleDetector.flagAccelIdleChanged;
        }

        public static void IdleDetectorInit(IdleDetector idleDetector, double sensitivity, int idleTime)
        {
        ...
        public static int CrossDetector(double signal1)
        {
        ...
        public static double Threshold(double signal, Threshold threshold)
        {
